...
#define FLASH_ITS_AREA_SIZE             (KEYSTORE_FLASH_SIZE)
...
#define S_RAM_ALIAS_BASE   (0x20000028)
#define S_RAM_ALIAS_LIMIT  (0x2000C000)

#define NS_ROM_ALIAS_BASE  (0x10038000)
#define NS_ROM_ALIAS_LIMIT (0x100E8000)
#define NS_RAM_ALIAS_BASE  (0x3000C000)
#define NS_RAM_ALIAS_LIMIT (0x30028800)

#define TOTAL_ROM_SIZE FLASH_TOTAL_SIZE
#define TOTAL_RAM_SIZE (0x00028800)
