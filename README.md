...
This is version 9.11.01.19 of the LPF3 SDK. This release includes:

* Bluetooth LE Channel Sounding preview
* RAS/RAP server preview for Channel Sounding data transfer
* Repeat Channel Sounding procedures

More details, including supported devices, IDEs, and toolchains are provided in
the [LPF3 9.11.01.19 SDK release notes][sdk release notes].
...
One temporary, notable difference in this LPF3 9.11.01.19 SDK GitHub
...
[sdk release notes]: https://dev.ti.com/tirex/explore/node?node=A__ADMjnimJ4C5BfFnmM3X-jg__com.ti.SIMPLELINK_LOWPOWER_F3_SDK__58mgN04__9.11.01.19
[sdk docs]: https://dev.ti.com/tirex/explore/node?node=A__AHaph7YfvcrVy2cDlmb4sQ__com.ti.SIMPLELINK_LOWPOWER_F3_SDK__58mgN04__9.11.01.19
