...
static const uint32_t LRF_subPhy1Mbps2MbpsCodedRegConfig[] =
{
    ...
    /************************************/
    /*********PBE_BLE5_RAM.FIFOCFG - modified from the original RCL drop and that it should eventually be handled by sysconfig.**/
    /** this is the only change that this differ from the rcl_settings_ble.c from RCL pkg ****/
    0x20320017,                       //         PBE_BLE5_RAM.FIFOCFG
    /************************************/
