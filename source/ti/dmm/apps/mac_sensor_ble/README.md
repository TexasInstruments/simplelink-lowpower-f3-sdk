...
The `mac_sensor_ble` application demonstrates the integration of BLE and 15.4 protocols using the Dynamic Multi-protocol Manager (DMM). It provides BLE GATT services for provisioning and sensor data reporting, enabling seamless communication between BLE central devices and 15.4 networks.
