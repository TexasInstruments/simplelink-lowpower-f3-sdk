...
//
// Generated on  2023-12-05 12:18:15
// by user:      developer
// on machine:   swtools
// CWD:          /home/developer/.conan/data/loki-lrf/7.40.01.13/library-lprf/ga/build/0c46501566d33cb4afdce9818f8c3e61ffe04c9a/build/highlrfbledig/iar/pbe/ble_cs
// Commandline:  /home/developer/.conan/data/loki-lrf/7.40.01.13/library-lprf/ga/build/0c46501566d33cb4afdce9818f8c3e61ffe04c9a/highlrfbledig/../tools/topsm/regtxtconv.pl -x /home/developer/.conan/data/f65lokihighlrfbledig/1.3.7-3/library-lprf/eng/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/source/ti.com_LOKI_LRFBLEDIG_1.0.xml -f acr --devices CC2745P10Q1:A (1.0) /home/developer/.conan/data/loki-lrf/7.40.01.13/library-lprf/ga/build/0c46501566d33cb4afdce9818f8c3e61ffe04c9a/highlrfbledig/pbe/ble_cs/doc/pbe_ble_cs_ram_regs.txt /home/developer/.conan/data/loki-lrf/7.40.01.13/library-lprf/ga/build/0c46501566d33cb4afdce9818f8c3e61ffe04c9a/highlrfbledig/pbe/ble_cs/doc/pbe_ble_cs_regdef_regs.txt
...
//
// /home/developer/.conan/data/loki-lrf/7.40.01.13/library-lprf/ga/build/0c46501566d33cb4afdce9818f8c3e61ffe04c9a/highlrfbledig/pbe/ble_cs/doc/pbe_ble_cs_ram_regs.txt
//   rcs-info: (file not managed or unknown revision control system)
//   git-hash: be0ccb162b8dc4c16ed9e5cd1915985dd5f15ed5
//
// ===========================================================================
...
// 
#define PBE_BLE_CS_RAM_O_TRXTIMEOUT                                  0x00000038U

// 
#define PBE_BLE_CS_RAM_O_TSW                                         0x0000003AU

// 
#define PBE_BLE_CS_RAM_O_TRXTIMEOUTI0                                0x0000003CU

// 
#define PBE_BLE_CS_RAM_O_TRXTIMEOUTI3                                0x0000003EU

// 
#define PBE_BLE_CS_RAM_O_TPILOTADJ                                   0x00000040U

// 
#define PBE_BLE_CS_RAM_O_TIPADJR0                                    0x00000042U

// 
#define PBE_BLE_CS_RAM_O_TIPADJR2                                    0x00000044U

// 
#define PBE_BLE_CS_RAM_O_TIPADJR3                                    0x00000046U

// 
#define PBE_BLE_CS_RAM_O_DEMMISC3                                    0x00000048U

// 
#define PBE_BLE_CS_RAM_O_TSWADJA                                     0x0000004AU

// 
#define PBE_BLE_CS_RAM_O_TSWADJB                                     0x0000004CU

// 
#define PBE_BLE_CS_RAM_O_S2ROUTIDX                                   0x0000004EU

// 
#define PBE_BLE_CS_RAM_O_FOFFSUM                                     0x00000050U

// 
#define PBE_BLE_CS_RAM_O_FOFFNUM                                     0x00000052U

// 
#define PBE_BLE_CS_RAM_O_FOFFLAST                                    0x00000054U

// 
#define PBE_BLE_CS_RAM_O_RSSILAST                                    0x00000056U

// 
#define PBE_BLE_CS_RAM_O_NSTEPSDONE                                  0x00000058U

// 
#define PBE_BLE_CS_RAM_O_TSTEPACCL                                   0x0000005AU

// 
#define PBE_BLE_CS_RAM_O_TSTEPACCH                                   0x0000005CU

// 
#define PBE_BLE_CS_RAM_O_TSTEPACCTHRL                                0x0000005EU

// 
#define PBE_BLE_CS_RAM_O_TSTEPACCTHRH                                0x00000060U

// 
#define PBE_BLE_CS_RAM_O_TSTEPCOMP                                   0x00000062U

// 
#define PBE_BLE_CS_RAM_O_TPOSTPROCESSDIV1                            0x00000064U

// 
#define PBE_BLE_CS_RAM_O_TPOSTPROCESSDIV12                           0x00000066U
...
//
// 
#define PBE_BLE_CS_RAM_TRXTIMEOUT_VAL_W                                      16U
#define PBE_BLE_CS_RAM_TRXTIMEOUT_VAL_M                                  0xFFFFU
#define PBE_BLE_CS_RAM_TRXTIMEOUT_VAL_S                                       0U
...
//
// 
#define PBE_BLE_CS_RAM_TIPADJR0_VAL_W                                        16U
#define PBE_BLE_CS_RAM_TIPADJR0_VAL_M                                    0xFFFFU
#define PBE_BLE_CS_RAM_TIPADJR0_VAL_S                                         0U
...
//
// 
#define PBE_BLE_CS_RAM_TIPADJR2_VAL_W                                        16U
#define PBE_BLE_CS_RAM_TIPADJR2_VAL_M                                    0xFFFFU
#define PBE_BLE_CS_RAM_TIPADJR2_VAL_S                                         0U
...
//
// 
#define PBE_BLE_CS_RAM_TIPADJR3_VAL_W                                        16U
#define PBE_BLE_CS_RAM_TIPADJR3_VAL_M                                    0xFFFFU
#define PBE_BLE_CS_RAM_TIPADJR3_VAL_S                                         0U
