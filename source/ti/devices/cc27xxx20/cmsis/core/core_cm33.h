...
/* Memory mapping of Core Hardware */
  ...
  #define DCB_BASE_CMSIS      (0xE000EDF0UL)                             /*!< DCB Base Address */
  #define DIB_BASE_CMSIS      (0xE000EFB0UL)                             /*!< DIB Base Address */
  ...
  #define DCB                 ((DCB_Type       *)     DCB_BASE_CMSIS   ) /*!< DCB configuration struct */
  #define DIB                 ((DIB_Type       *)     DIB_BASE_CMSIS   ) /*!< DIB configuration struct */

  #if defined (__MPU_PRESENT) && (__MPU_PRESENT == 1U)
    #define MPU_BASE_CMSIS    (SCS_BASE +  0x0D90UL)                     /*!< Memory Protection Unit */
    #define MPU               ((MPU_Type       *)     MPU_BASE_CMSIS   ) /*!< Memory Protection Unit */
  #endif

  #if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
    #define SAU_BASE_CMSIS    (SCS_BASE +  0x0DD0UL)                     /*!< Security Attribution Unit */
    #define SAU               ((SAU_Type       *)     SAU_BASE_CMSIS   ) /*!< Security Attribution Unit */
  #endif
