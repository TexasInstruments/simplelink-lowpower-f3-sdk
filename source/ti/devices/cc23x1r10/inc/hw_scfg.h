...
typedef struct {
    ...
    // [216]: length 4B
    uint32_t fastBoot;
        #define SCFG_FAST_BOOT_WURX             0x5E8A574EU
        #define SCFG_FAST_BOOT_TIMER            0x1D5688CAU
        #define SCFG_FAST_BOOT_IO               0x35B70BCEU
        #define SCFG_FAST_BOOT_WURX_OR_TIMER    0x1404ACF5U
        #define SCFG_FAST_BOOT_WURX_OR_IO       0x3E839CD9U
        #define SCFG_FAST_BOOT_IO_OR_TIMER      0x6ED0F3B1U
        #define SCFG_FAST_BOOT_ANY              0x2DAD8C17U
        #define SCFG_FAST_BOOT_DISABLED         0x25BFEB2AU
...
#define SCFG_INVALID_KEY_ENTRY \
    ...
    #define SCFG_OFFSET_216_DEFAULT .fastBoot = SCFG_FAST_BOOT_ANY
