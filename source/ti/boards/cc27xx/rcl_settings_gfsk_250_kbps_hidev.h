...
#ifndef RCLSETTINGSGFSK250KBPSHIDEV_H
#define RCLSETTINGSGFSK250KBPSHIDEV_H
...
// LRF data structures
extern const LRF_TxShape      LRF_shapeBaseGfsk05Gfsk250KbpsHidev;
extern const LRF_SwConfig     LRF_swConfigGfsk250KbpsHidev;
extern const LRF_TxPowerTable LRF_txPowerTableGfsk250KbpsHidev;
extern const LRF_Config       LRF_configGfsk250KbpsHidev;
...
// 0x20C8     LRFDMDM            MODSYMMAP0           [15:12]    SYM3               0x3
// 0x20C8     LRFDMDM            MODSYMMAP0           [11:8]     SYM2               0xD
// 0x20C8     LRFDMDM            MODSYMMAP0           [7:4]      SYM1               0x1
// 0x20C8     LRFDMDM            MODSYMMAP0           [3:0]      SYM0               0xF
// 0x20CC     LRFDMDM            MODSYMMAP1           [15:12]    SYM7               0x3
// 0x20CC     LRFDMDM            MODSYMMAP1           [11:8]     SYM6               0xD
// 0x20CC     LRFDMDM            MODSYMMAP1           [7:4]      SYM5               0x1
// 0x20CC     LRFDMDM            MODSYMMAP1           [3:0]      SYM4               0xF
...
// 0x20E8     LRFDMDM            DEMMISC2             [0]        PDIFLIMITRANGE     0x0
// 0x20EC     LRFDMDM            DEMMISC3             [14:13]    BDE2DVGA           0x2
// 0x20EC     LRFDMDM            DEMMISC3             [12]       BDE1FILTMODE       0x0
// 0x20EC     LRFDMDM            DEMMISC3             [11:10]    LQIPERIOD          0x1
// 0x20EC     LRFDMDM            DEMMISC3             [9:8]      BDE1DVGA           0x2
// 0x20EC     LRFDMDM            DEMMISC3             [7]        BDE1NUMSTAGES      0x1
// 0x20EC     LRFDMDM            DEMMISC3             [6:5]      PDIFDECIM          0x0
// 0x20EC     LRFDMDM            DEMMISC3             [4:0]      BDE2DECRATIO       0x03
// 0x20F0     LRFDMDM            DEMIQMC0             [15:8]     GAINFACTOR         <TRIM>
// 0x20F0     LRFDMDM            DEMIQMC0             [7:0]      PHASEFACTOR        <TRIM>
// 0x20F4     LRFDMDM            DEMDSBU              [8:0]      DSBUDELAY          0x00E
// 0x20F8     LRFDMDM            DEMDSBU2             [8:0]      DSBUAVGLENGTH      0x08D
// 0x20FC     LRFDMDM            DEMCODC0             [11]       ESTSEL             0x0
// 0x20FC     LRFDMDM            DEMCODC0             [10:9]     COMPSEL            0x3
// 0x20FC     LRFDMDM            DEMCODC0             [8]        IIRUSEINITIAL      0x0
// 0x20FC     LRFDMDM            DEMCODC0             [7:5]      IIRGAIN            0x3
// 0x20FC     LRFDMDM            DEMCODC0             [4]        IIREN              0x1
// 0x20FC     LRFDMDM            DEMCODC0             [3]        ACCMODE            0x0
// 0x20FC     LRFDMDM            DEMCODC0             [2:1]      ACCPERIOD          0x0
// 0x20FC     LRFDMDM            DEMCODC0             [0]        ACCEN              0x0
// 0x2100     LRFDMDM            DEMFIDC0             [5:4]      COMPSEL            0x0
// 0x2100     LRFDMDM            DEMFIDC0             [3:2]      ACCPERIOD          0x0
// 0x2100     LRFDMDM            DEMFIDC0             [1]        ACCMODE            0x0
// 0x2100     LRFDMDM            DEMFIDC0             [0]        ACCEN              0x0
// 0x2104     LRFDMDM            DEMFEXB0             [13]       OUT2PASSTHROUGH    0x0
// 0x2104     LRFDMDM            DEMFEXB0             [12:11]    OUT2SRCSEL         0x0
// 0x2104     LRFDMDM            DEMFEXB0             [10]       OUT1PASSTHROUGH    0x0
// 0x2104     LRFDMDM            DEMFEXB0             [9:8]      OUT1SRCSEL         0x1
// 0x2104     LRFDMDM            DEMFEXB0             [7:6]      B4SRCSEL           0x0
// 0x2104     LRFDMDM            DEMFEXB0             [5:4]      B3SRCSEL           0x0
// 0x2104     LRFDMDM            DEMFEXB0             [3:2]      B2SRCSEL           0x1
// 0x2104     LRFDMDM            DEMFEXB0             [1:0]      B1SRCSEL           0x2
...
// 0x210C     LRFDMDM            DEMMAFI0             [15:8]     C1C7               0x01
// 0x210C     LRFDMDM            DEMMAFI0             [7:0]      C0C8               0x00
// 0x2110     LRFDMDM            DEMMAFI1             [15:8]     C3C5               0x30
// 0x2110     LRFDMDM            DEMMAFI1             [7:0]      C2C6               0x0D
// 0x2114     LRFDMDM            DEMMAFI2             [8:0]      C4                 0x04B
...
// 0x211C     LRFDMDM            DEMC1BE1             [15:8]     THRESHOLDB         0x27
...
// 0x22A0     LRFDMDM            BAUDCOMP             [1:0]      SCALEVAL           0x3
// 0x308C     LRFDRFE            RSSIOFFSET           [7:0]      VAL                <TRIM>
...
// 0x30A4     LRFDRFE            SPARE2               [15:0]     VAL                0x3F13
// 0x30A8     LRFDRFE            SPARE3               [15:0]     VAL                0x0AB0
// 0x30AC     LRFDRFE            SPARE4               [15:0]     VAL                0x0000
// 0x30B0     LRFDRFE            SPARE5               [15:0]     VAL                0x7C00
// 0x30B4     LRFDRFE            LNA                  [7:4]      TRIM               <TRIM>
// 0x30B4     LRFDRFE            LNA                  [3]        MIXCAP             0x0
// 0x30B4     LRFDRFE            LNA                  [2:1]      IB                 0x1
// 0x30B8     LRFDRFE            IFAMPRFLDO           [15:9]     TRIM               <TRIM>
// 0x30B8     LRFDRFE            IFAMPRFLDO           [7:4]      AAFCAP             <TRIM>
...
// 0x2024     PBE_GENERIC_RAM    PKTCFG               [10]       CRCORDER           0x0
...
// 0x683C     RFE_COMMON_RAM     PHYRSSIOFFSET        [7:0]      VAL                0x5A
// 0x6840     RFE_COMMON_RAM     SPARE1SHADOW         [15:0]     VAL                0x002E
// 0x6842     RFE_COMMON_RAM     AGCINFO              [0]        MODE               0x1
// 0x6844     RFE_COMMON_RAM     PATRIM01             [12:8]     VAL1               0x00
// 0x6844     RFE_COMMON_RAM     PATRIM01             [4:0]      VAL0               0x00
// 0x6846     RFE_COMMON_RAM     PATRIM23             [12:8]     VAL3               0x00
// 0x6846     RFE_COMMON_RAM     PATRIM23             [4:0]      VAL2               0x00
