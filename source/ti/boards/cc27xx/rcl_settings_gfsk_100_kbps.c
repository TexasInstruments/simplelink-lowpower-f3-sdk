...
#include "rcl_settings_gfsk_100_kbps.h"
...
static const uint32_t LRF_commonRegConfig[] =
{
    ...
    (uint32_t) &LRF_swConfigGfsk100Kbps,        //         LRF_swParam : swConfig
    (uint32_t) &LRF_txPowerTableGfsk100Kbps,    //         LRF_swParam : txPowerTable
    ...
    0xC0000A18,                                 //         LRFDMDM.SPARE1                      LRFDMDM.SPARE0
...
const LRF_TxShape LRF_shapeBaseGfsk05Gfsk100Kbps = {
    .scale                 = 0x0F183,
    .numCoeff              = 0x0014,
...
const LRF_SwConfig LRF_swConfigGfsk100Kbps = {
    .rxIntFrequency        = 500000,
    .rxFrequencyOffset     = 0,
    .txFrequencyOffset     = 500000,
    .modFrequencyDeviation = 0x000061A8,
    .txShape               = &LRF_shapeBaseGfsk05Gfsk100Kbps,
    .bwIndex               = 0x00,
    .bwIndexDither         = 0x00 
};

// LRF_TxPowerTable data structure
const LRF_TxPowerTable LRF_txPowerTableGfsk100Kbps = {
...
const LRF_Config LRF_configGfsk100Kbps = {
