...
#include "rcl_settings_gfsk_1_mbps.h"
...
{
    0x00000053,                               // Segment length = 83
    0x0000A002,                               //     Data structure 32-bit region (start byte position = 0, count = 3)
    (uint32_t) &LRF_swConfigGfsk1Mbps,        //         LRF_swParam : swConfig
    (uint32_t) &LRF_txPowerTableGfsk1Mbps,    //         LRF_swParam : txPowerTable
    ...
    0x000C4000,                               //         LRFDMDM.BAUDPRE                     LRFDMDM.BAUD
    0x03870000,                               //         LRFDMDM.DEMMISC0                    LRFDMDM.MODMAIN
    0x15FB0001,                               //         LRFDMDM.DEMMISC2                    LRFDMDM.DEMMISC1
    0x00001182,                               //         LRFDMDM.DEMIQMC0                    LRFDMDM.DEMMISC3
    0x00800087,                               //         LRFDMDM.DEMDSBU2                    LRFDMDM.DEMDSBU
    0x00000F50,                               //         LRFDMDM.DEMFIDC0                    LRFDMDM.DEMCODC0
    ...
    0x017F2727,                               //         LRFDMDM.DEMC1BE2                    LRFDMDM.DEMC1BE1
...
const LRF_TxShape LRF_shapeBaseGfsk067Gfsk1Mbps = {
    .scale                 = 0x0FDE2,
    .numCoeff              = 0x0011,
...
const LRF_SwConfig LRF_swConfigGfsk1Mbps = {
    .rxIntFrequency        = 1000000,
    .rxFrequencyOffset     = 0,
    .txFrequencyOffset     = 1000000,
    .modFrequencyDeviation = 0x00027100,
    .txShape               = &LRF_shapeBaseGfsk067Gfsk1Mbps,
    .bwIndex               = 0x00,
    .bwIndexDither         = 0x01 
};

// LRF_TxPowerTable data structure
const LRF_TxPowerTable LRF_txPowerTableGfsk1Mbps = {
...
const LRF_Config LRF_configGfsk1Mbps = {
