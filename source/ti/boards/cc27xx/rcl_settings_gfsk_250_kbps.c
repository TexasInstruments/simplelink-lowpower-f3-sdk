...
#include "rcl_settings_gfsk_250_kbps.h"
...
static const uint32_t LRF_commonRegConfig[] =
{
    ...
    (uint32_t) &LRF_swConfigGfsk250Kbps,        //         LRF_swParam : swConfig
    (uint32_t) &LRF_txPowerTableGfsk250Kbps,    //         LRF_swParam : txPowerTable
...
const LRF_TxShape LRF_shapeBaseGfsk05Gfsk250Kbps = {
    .scale                 = 0x0F183,
    .numCoeff              = 0x0014,
...
const LRF_SwConfig LRF_swConfigGfsk250Kbps = {
    .rxIntFrequency        = 500000,
    .rxFrequencyOffset     = 0,
    .txFrequencyOffset     = 500000,
    .modFrequencyDeviation = 0x0000F424,
    .txShape               = &LRF_shapeBaseGfsk05Gfsk250Kbps,
    .bwIndex               = 0x00,
    .bwIndexDither         = 0x00 
};

// LRF_TxPowerTable data structure
const LRF_TxPowerTable LRF_txPowerTableGfsk250Kbps = {
...
const LRF_Config LRF_configGfsk250Kbps = {
