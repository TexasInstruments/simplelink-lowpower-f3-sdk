 ...
 *     - [0] = LGPT
 *     - [7] = IOC
 *     - [17] = Flash Bank 2 Trim read (CC27XXX20 devices only)
 *     - [18] = Flash Bank 2 Non-main region 0 read (CC27XXX20 devices only)
 *     - [19] = Flash Bank 2 Non-main region 1 read (CC27XXX20 devices only)
 *     - [20] = Flash Bank 3 Trim read (CC27XXX20 devices only)
 *     - [21] = Flash Bank 3 Non-main region 0 read (CC27XXX20 devices only)
 *     - [22] = Flash Bank 3 Non-main region 1 read (CC27XXX20 devices only)
 */
#define GASKET_ENABLE_0  0x00E80083U
    ...
    /* Separate define for CC27XXX20 devices in case bits 17-22 need to be handled differently */
    #define GASKET_ENABLE_1  0x0001FF7EU
#else
    #error "Gasket configuration is not defined for this device"
#endif
