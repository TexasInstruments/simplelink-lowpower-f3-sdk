...
/* This implementation of packing objects differs from upstream mcuboot and aligns with other TI oad examples
    This leads to a variance in object definitions compared to upstream mcuboot*/
