...
''' ROM SECURE BOOT Supports 3 algorithms - SHA512, ECDSA512, and RSA3072PKCS. Secure boot uses imgtool to sign the images
    Therefore, the TLV values need to align with secure boot TLV values for now. 
    This means SIG_PURE can not be supported yet, and TLVs regarding SHA, ECDSA, and RSA should not be updated'''
TLV_VALUES = {
        'KEYHASH': 0x01,
        'PUBKEY': 0x02,
        'SHA256': 0x10,
