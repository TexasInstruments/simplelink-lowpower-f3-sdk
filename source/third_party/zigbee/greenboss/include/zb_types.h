...
#ifndef ZB_CONFIG_H
#error zb_config.h must be included before zb_types.h. Dont do it directly. Include zb_common.h instead.
#endif
...
#ifdef ZB_NEED_ALIGN
/**
   Converts 16-bits integer from the host endian to the little endian.
 ...
 *    @brief Copies long address.
 *    @param dst Destination address
 *    @param src Source address
 *
 *    @def ZB_64BIT_ADDR_CMP
 *    @brief Checks if two long addresses are equal.
 *    @param one Address to be compared
