 ...
 */
/* TI-MBEDTLS: This function is only called if the same condition is met in
...
/* TI-MBEDTLS: Fix compiler warning for declared but unused variable */
...
/* TI-MBEDTLS: Fix compiler warning for unreachable statement. To reach this statement,
 * the above two switch statements must have more than just their 'default' cases
 * compiled in. This macro check guarantees that both switch statements had at least
