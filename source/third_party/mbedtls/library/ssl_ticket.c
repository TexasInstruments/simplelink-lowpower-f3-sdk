...
#if defined(MBEDTLS_HAVE_TIME)
    /* TI-MBEDTLS: Moved variable declaration to avoid compiler warning regarding
     * goto statements bypassing the initialization of the ticket_lifetime variable.
     */
    mbedtls_ms_time_t ticket_creation_time, ticket_age, ticket_lifetime;
#endif
