 ...
 *  - Comment out 'mbedtls/private_access.h' include
 *  - Add HSM Asset Store key persistence and location
 *  - Add MBEDTLS_PSA_CRYPTO_KEY_ID_ENCODES_OWNER define
 *  - Add PSA_ERROR_KEY_IN_USE, PSA_ERROR_HUK_NOT_PROVISIONED, and
 *    PSA_ERROR_ASSET_STORE_FULL status codes.
 */
 ...
 *
 * This is CCM* as specified in IEEE 802.15.4 s7, with a tag length of 0.
 ...
 * RFC 8032 s5.1.6 and s5.2.6 (a 64-byte string for Ed25519, a 114-byte
 * string for Ed448).
 */
